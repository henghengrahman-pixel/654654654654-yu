...
async function fetchList({append=false,silent=false,reason='user'}={}){
  ...
  try{
    ...
    const counts=data.laneCounts||{};$('#laneMyCount').textContent=String(counts.MY_CHAT||0);$('#laneQueuedCount').textContent=String(counts.QUEUED||0);$('#laneSupervisedCount').textContent=String(counts.SUPERVISED||0);
