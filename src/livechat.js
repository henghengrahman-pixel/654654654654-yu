...
export class LiveChatClient {
  ...
  classifyChatLane(summary={}) {
    ...
    // Backward-compatible fail-open: older list_chats shapes may omit membership/follow data.
    // Those chats keep the previous all_active behaviour instead of disappearing.
    return 'MY_CHAT';
  }
